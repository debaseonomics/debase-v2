import React, { useState, useEffect, useContext } from '@domains/Dapp/views/Pools/views/incentivizers/Dai/@domains/Dapp/views/Pools/Pools/incentivizers/Dai/react';

import useSWR from '@domains/Dapp/views/Pools/views/incentivizers/Dai/@domains/Dapp/views/Pools/Pools/incentivizers/Dai/swr';
import { formatEther, formatUnits, parseEther, parseUnits } from '@domains/Dapp/views/Pools/views/incentivizers/Dai/@domains/Dapp/views/Pools/Pools/incentivizers/Dai/ethers/lib/utils';
import { Contract } from '@domains/Dapp/views/Pools/views/incentivizers/Dai/@domains/Dapp/views/Pools/Pools/incentivizers/Dai/ethers';
...
import { contractAddress, poolAbi, lpAbi, fetcher } from '@domains/Dapp/views/Pools/views/incentivizers/Dai/@domains/Dapp/views/Pools/Pools/incentivizers/Dai/utils';

/* import components */
import { Button, Input, Flexbox } from '@domains/Dapp/views/Pools/views/incentivizers/Dai/@domains/Dapp/views/Pools/Pools/incentivizers/Dai/domains/Dapp/views/DashboardView/components/common';
import { PoolStake } from '@domains/Dapp/views/Pools/views/incentivizers/Dai/@domains/Dapp/views/Pools/Pools/incentivizers/Dai/domains/Dapp/views/DashboardView/components/layout';
/* import context */
import { SnackbarContext } from '@domains/Dapp/views/Pools/views/incentivizers/Dai/@domains/Dapp/views/Pools/Pools/incentivizers/Dai/domains/Dapp/views/DashboardView/components/common';
