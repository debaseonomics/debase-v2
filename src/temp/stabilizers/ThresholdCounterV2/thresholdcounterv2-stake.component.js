import React, { useState, useEffect, useContext } from '@domains/Dapp/views/Pools/stabilizers/ThresholdCounterV2/react';

import useSWR from '@domains/Dapp/views/Pools/stabilizers/ThresholdCounterV2/swr';
import { formatEther, formatUnits, parseEther, parseUnits } from '@domains/Dapp/views/Pools/stabilizers/ThresholdCounterV2/ethers/lib/utils';
import { Contract } from '@domains/Dapp/views/Pools/stabilizers/ThresholdCounterV2/ethers';
import { useWeb3React } from '@domains/Dapp/views/Pools/stabilizers/ThresholdCounterV2/@web3-react/core';
import { contractAddress, poolAbi, lpAbi, fetcher } from '@domains/Dapp/views/Pools/stabilizers/ThresholdCounterV2/utils';

/* import components */
import { Button, Input, Flexbox } from '@domains/Dapp/views/Pools/stabilizers/ThresholdCounterV2/domains/Dapp/views/DashboardView/components/common';
import { PoolStake } from '@domains/Dapp/views/Pools/stabilizers/ThresholdCounterV2/domains/Dapp/views/DashboardView/components/layout';
/* import context */
import { SnackbarContext } from '@domains/Dapp/views/Pools/stabilizers/ThresholdCounterV2/domains/Dapp/views/DashboardView/components/common';
