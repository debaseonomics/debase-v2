import React, { useState, useEffect, useContext } from '@domains/Dapp/views/Pools/stabilizers/ThresholdCounter/react';

import useSWR from '@domains/Dapp/views/Pools/stabilizers/ThresholdCounter/swr';
import { formatEther, formatUnits, parseEther, parseUnits } from '@domains/Dapp/views/Pools/stabilizers/ThresholdCounter/ethers/lib/utils';
import { Contract } from '@domains/Dapp/views/Pools/stabilizers/ThresholdCounter/ethers';
import { useWeb3React } from '@domains/Dapp/views/Pools/stabilizers/ThresholdCounter/@web3-react/core';
import { contractAddress, poolAbi, lpAbi, fetcher } from '@domains/Dapp/views/Pools/stabilizers/ThresholdCounter/utils';

/* import components */
import { Button, Input, Flexbox } from '@domains/Dapp/views/Pools/stabilizers/ThresholdCounter/domains/Dapp/views/DashboardView/components/common';
import { PoolStake } from '@domains/Dapp/views/Pools/stabilizers/ThresholdCounter/domains/Dapp/views/DashboardView/components/layout';
/* import context */
import { SnackbarContext } from '@domains/Dapp/views/Pools/stabilizers/ThresholdCounter/domains/Dapp/views/DashboardView/components/common';
