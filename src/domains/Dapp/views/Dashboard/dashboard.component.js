	...
	return (
		<Fragment>
			<Section label="current statistics">
				<Grid>
					<LabeledCard isLoading={ui.isLoading.tokenData} label="debase" gutter={0} color="primary">
						<List data={debaseListData} />
					</LabeledCard>
					<LabeledCard isLoading={ui.isLoading.tokenData} label="degov" gutter={0} color="primary">
