        ...
        <StyledRoadmap>
            ...
            <StyledContent>
                ...
                <StyledItem>
                    ...
                    <StyledCircleIcon src={roadmapActivePNG} />
                    <StyledTextContainer>
                        Investment in <StyledSpanLink href="https://dopexio.gitbook.io/dopex/" target="_blank">DOPEX</StyledSpanLink>, an on-chain options protocol
                        <br />
                ...
                <StyledItem>
                    ...
                    <StyledTextContainer>
                        Release new version of pool with <StyledSpanLink href="https://88mph.app/" target="_blank">88MPH</StyledSpanLink>, No deposit
                        <br />
                ...
                <StyledItem>
                    ...
                    <StyledCircleIcon src={roadmapInactivePNG} />
                    <StyledTextContainer>
                        <StyledSpanPink>Debase Website V2</StyledSpanPink> goes live! Incorporates feedback from community
                        <br />
                ...
                <StyledItem>
                    ...
                    <StyledCircleIcon src={roadmapInactivePNG} />
                    <StyledTextContainer>
                        Release of full economic model of <StyledSpanPink>SP4</StyledSpanPink>  (the mechanism that creates
                        <br />
                ...
                <StyledItem>
                    ...
                    <StyledCircleIcon src={roadmapInactivePNG} />
                    <StyledTextContainer>
                        <StyledSpanPink>SP4 MVP</StyledSpanPink> development work commences and <StyledSpanPink>dSTABLE</StyledSpanPink> launches,
                        <br />
